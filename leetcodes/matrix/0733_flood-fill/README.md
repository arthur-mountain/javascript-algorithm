...
- 複習1(BFS)：2025-11-21 | 耗時：9分鐘 | 獨立完成：是 | 順暢度：流暢

- 複習2(BFS)：2025-11-24 | 耗時：8分鐘 | 獨立完成：是 | 順暢度：流暢
...
- 複習5(BFS)：2026-04-18 | 耗時：20分鐘 | 獨立完成：否 | 順暢度：卡住。

  - 概念和流程都是正確的。因為一直沒想到這個 case 所以卡住(提前判斷：若起始值已經等於目標 color，直接返回 image)
