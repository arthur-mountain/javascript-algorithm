...
- 複習3：2025-11-11 | 耗時：2分鐘 | 獨立完成：是 | 順暢度：流暢。

- 複習4：2025-12-11 | 耗時：13分鐘 | 獨立完成：是 | 順暢度：流暢。

  - 註解寫比較久。 另外雖然有寫註解跟推導，但實質上更多是記得解法、寫法，所以有點不準

- 複習5 (Solution2)：2026-02-28 | 耗時：10分鐘 | 獨立完成：是 | 順暢度：流暢。
