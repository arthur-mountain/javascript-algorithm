...
- 複習4：2025-12-26 | 耗時：9分鐘(5分鐘釐清題目，4分鐘實作信份分數演算法) | 獨立完成：是 | 順暢度：卡頓。

  - 有寫出來但感覺是把答案回想起來，沒有情境映射的過程(像是入度、出度的概念，雖然有印象，但沒辦法在腦海中抽象出來，而是回想起來而已)

- 複習5：2026-03-29 | 耗時：11分鐘 | 獨立完成：是 | 順暢度：流暢。
