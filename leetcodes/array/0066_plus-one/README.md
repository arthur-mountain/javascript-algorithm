...
- 複習1(solution1)：2025-11-01 | 耗時：12分鐘(3分鐘釐清題目、3分鐘釐清實作，6分鐘實作) | 獨立完成：是 | 順暢度：卡頓。

  - 沒有寫出最佳解而是寫出 solution1 並且程式碼也沒很乾淨，有些冗餘的邏輯

- 複習2(Solution2)：2025-11-04 | 耗時：5分鐘 | 獨立完成：是 | 順暢度：算流暢，但仍有待加強。不過有寫出最佳解

- 複習3(Solution2)：2025-11-11 | 耗時：3分鐘 | 獨立完成：是 | 順暢度：算流暢。

  - 有點像是有印象的寫，雖然過程中整體思考邏輯是清楚，待下次複習再觀察看看

- 複習4(Solution2)：2025-12-11 | 耗時：5分鐘 | 獨立完成：是 | 順暢度：流暢。

- 複習5(Solution2)：2026-03-01 | 耗時：10分鐘 | 獨立完成：是 | 順暢度：流暢。寫註解寫比較久，思路是流暢的
